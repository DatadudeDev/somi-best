...
import { buildPrivacySections, getLegalContext } from '../lib/legal-content';
    ...
    <div>
      ...
      >
        <div>
          ...
          >
            Effective {effective}. {site.legal.companyLegalName} ({biz}) is committed to handling your personal information responsibly.
          </motion.p>
        </div>
      </section>
